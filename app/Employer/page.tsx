  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-muted text-gray-800">
      ...
      <main className="flex-1 p-4 bg-[url('/dashboard.png')] bg-cover md:p-8">
        ...
        {/* Jobs Posted Section */}
        <section className="mt-6 bg-white/40 backdrop-blur-lg p-6 rounded-xl shadow-xl text-primary">
          ...
          <ul className="space-y-4">
            <li className="p-4 bg-white rounded-lg shadow hover:shadow-lg">
              ...
              <p className="text-sm text-gray-600">10 applications received • Posted on: May 12, 2025</p>
            </li>
            <li className="p-4 bg-white rounded-lg shadow hover:shadow-lg">
              <h3 className="text-lg font-semibold">UI/UX Designer Role</h3>
              <p className="text-sm text-gray-600">5 interviews scheduled • Posted on: May 8, 2025</p>
            </li>
          </ul>
        </section>
      </main>
